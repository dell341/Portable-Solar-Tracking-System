...
public:
    ...
    DRV8834(int steps, int dir_pin, int step_pin, int sleep_pin);
    DRV8834(int steps, int dir_pin, int step_pin, int sleep_pin, int enable_pin);
    /*
     * Fully wired. All the necessary control pins for DRV8834 are connected.
     */
    DRV8834(int steps, int dir_pin, int step_pin, int m0_pin, int m1_pin, bool placeholder);
